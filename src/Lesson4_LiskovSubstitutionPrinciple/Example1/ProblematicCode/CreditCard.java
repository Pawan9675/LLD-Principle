...
public abstract class CreditCard {
    ...
    public abstract void upiPayment();        // Problem: Not all cards support UPI
    public abstract void intlPayment();       // Problem: Not all cards support International payments
